    ...
    <div className="py-[64px]">
      <div className="container mx-4">
        <div className="text-center mb-[48px]">
          <div className="px-[16px] py-[8px] inline-block bg-yellow-100 rounded-2xl mb-[16px]">
            <p className="text-[14px] text-yellow-700 flex items-center gap-2 font-semibold">
              <svg
          ...
          <h2 className="mb-[16px] font-bold">
            Khách Hàng Nói Gì Về Chúng Tôi
          </h2>
          <p className="text-gray-600 text-lg">
            Hơn 10,000+ khách hàng tin tùy và hài lòng
          </p>
        </div>
