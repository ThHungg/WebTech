  ...
  return (
    <div className="p-[24px] w-full border border-gray-100 shadow-lg rounded-2xl">
      <h5 className="font-bold flex items-center gap-2">
        ...
        >
          <radialGradient
            id="IconifyId19a91699db73ce2990"
            cx="68.884"
            cy="124.296"
            r="70.587"
          ...
          <path
            fill="url(#IconifyId19a91699db73ce2990)"
          ...
          />
          <radialGradient
            id="IconifyId19a91699db73ce2991"
            cx="64.921"
            cy="54.062"
            r="73.86"
          ...
          <path
            fill="url(#IconifyId19a91699db73ce2991)"
...
export default memo(BestSellingProductsSection);
